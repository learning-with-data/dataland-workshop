  ...
  return (
    <>
      ...
      <Row>
        ...
        <p>
          What am I doing? Oh, just fishing by the side of this boat. Something
          that a human recently told me about. But honestly, look at this rod
          and this string. It’s pretty, um, inefficient, isn’t it?{" "}
        </p>
        <p>
          And you humans have a whole set of categories to talk about different
          kinds of fish—do you even see how random that is? Fish don’t just live
          in your categories, people. But I’m complaining too much. As long as
          that helps with your very slow way of fishing, I guess it’s fine.{" "}
        </p>
        <p>
          I mean, I also can’t always blame your category stuffs anyways. One
          time, those stuffs kind of helped me searching for my cousin. I guess
          at the end they didn’t, but they did until maybe halfway… Come, let me
          tell you the story.{" "}
        </p>
        <p>
      ...
      <Row>
        ...
        <p>
          ...
          went back to the land, and he wasn’t there. I asked our families, and
          no one knew where he had gone. They only told me that maybe he was
          gone before a huge snowstorm. Let me tell you, that’s not helping.{" "}
        </p>
        <p>
          I was so lost. I just couldn’t track him down the entire snow land.
          Well, that’s when you humans came in. Them someone told me that there
          was a group of you out there those days, following us everywhere, and
          one of you have been following my cousin. Look, I didn’t know what she
          wanted, and I didn’t judge her, but I thought you probably need to
          stop stalking us—I’m off my topic.{" "}
        </p>
        <p>
          So knowing that, I thought ok, at least that stalker, she could help
          me this time. So I figured where you humans were living. I think it’s
          called Palmer Station. I reached out to the humans there, and
          unsurprisingly, no one knew who my cousin was. Still, they offered to
          help.{" "}
        </p>
        <p>
          It also turned out that, fair enough, those humans were doing some
          scientific research for pretty noble reasons (I would prefer you just
          ask us, though). And then, they offered me one of your categorical
          stuffs—namely, datasets—and tools to help. So that’s when I got all of
      ...
      <Row>
        ...
        <ul>
          <li>
            Look at the codebook and discuss what the columns are about. How do
            you think humans may have gathered data for each column? What impact
            do you think that data gathering process may produce?{" "}
          </li>
          <li>
            Import the dataset into the Dataland window below. Skim through the
            data rows. What are the names and scales of measurements humans use
            to describe penguins and islands? What does it mean to categorize
            and measure things this way?{" "}
          </li>
        </ul>
        <h3>
          Task 0.2: After figuring out that dataset, let’s also try out the data
          analysis tools.
        </h3>
        <ul>
      ...
      <Row>
        <p>--</p>
        <p>
          That was a long process, wasn’t it? That was the first time I’ve ever
          seen those human tools, and they looked pretty wild. They still look
          wild to me now. I would really love to tell you how those tools
      ...
      <Row>
        <p>
          ...
          catch ten times more fish in a blink, and then come back up to take a
          nap with my stomach full. You sure need to endure some hunger to enjoy
          this.{" "}
        </p>
        <p>
          ...
          records from their boxes. With those, I started to figure out who that
          human was, and also which parts of the records were about my cousin.{" "}
        </p>
        <p>--</p>
      </Row>
      ...
      <Row>
        <h3>
          Task 1.1: The traveling penguin recalls that their families mentioned
          a human who always carries a big backpack. They also figured out that
          those humans at Palmer Station called their family Adelie. Use this
          information to find the human’s ID in the dataset.{" "}
        </h3>
        <ul>
          <li>
      ...
      <Row>
        ...
        <p>
          “I’m so sorry, my friend. We were just carrying out our research, and
          we didn’t know you could talk like this. And, that backpack was for
          specialized devices.” She said.{" "}
        </p>
        <p>
      ...
      <Row>
        ...
        <ul>
          <li>
            ...
            characteristics of the penguins, see how data cluster, and find the
            cluster that corresponds to the missing cousin.
          </li>
        </ul>
      </Row>
      ...
      <Row>
        ...
        <ul>
          <li>
            Filter out the data rows for the missing cousin and check the Human
            Notes column: they should all bear the same special mark.{" "}
          </li>
        </ul>
      </Row>
      ...
      <Row>
        <p>--</p>
        <p>
          So, that was how I found the records of my cousin. I still didn’t know
          if those records were gonna help, but it started to become
          interesting. For a while, I even forgot that my cousin might have been
          lost in the snowstorm. Ah, the guilty pleasure of playing detective.
          From there I started to trace my cousin, and then… Whoa! Finally! A
          fish on the hook! Come, human, help me out, my hands are not designed
          for this—
        </p>
        <p>(End of Act 1)</p>
      </Row>
      ...
      <Row>
        <p>
          ...
          kind wrote, the novel where someone caught a big fish in the middle of
          the ocean and lost it. It’s pretty romantic, isn’t it?
        </p>
        <p>
        ...
        <p>
          Now that we need to dry ourselves on the deck, why don’t we go back to
          my story? I was there with the big backpack researcher, and we figured
          out which data belonged to my cousin. You thought then we could just
          track him down, don’t you? Well, we realized that that researcher was
          stalking my cousin for her own project, and she didn’t keep the
          locations and times because she wasn’t really interested in those.{" "}
        </p>
        <p>
          Luckily, we had some extra things to help. The human researchers did
          ask the penguins what names they would use to call different lands and
          places, and the humans recorded those names as “Penguin Grids”. To say
          the truth, we don’t really think of places in grids, but that seems to
          be a metaphor that works for you.{" "}
        </p>
        <p>
      ...
      <Row>
        ...
        <p>
          ...
          calendars, but that was too rough. We couldn’t figure out where he was
          heading towards or which records were his last locations if we didn’t
          have more precise times.{" "}
        </p>
        <p>
        ...
        <p>
          ...
          part, the researcher surely outsmarted us both! It was a simple logic:
          she just assumed that the sea ice level always rose during the cooling
          season, that is, first half of your human year, and it always fell
          during the warming season, i.e. second half of year. That way, she
          only needed to map the sea ice levels on my cousin’s records between
          the minimum and maximum sea ice levels of each year, and Voila! We
          knew the order of these records!
        </p>
        <p>
          Did that go too fast? Eh, I guess you have to draw it out yourself. Do
          you have paper and pencil? Oh, is everything soaked already? Duh.
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                ...
                <ul>
                  <li>
                    Time Interpolation = 0.5 * (Sea Ice Level – Min Level)/(Max
                    Level – Min Level)
                  </li>
                </ul>
              </li>
      ...
      <Row>
        <p>--</p>
        <p>
          See how that worked? No? I know it’s a lot, human. That researcher was
          smart to come up with this plan. That way we knew how my cousin was
          moving over time, and the only thing left was to figure out where he
          was trying to go.{" "}
        </p>
        <p>
          For that, if you don’t mind, let’s get into the cabin and talk about
          it. The wind is getting cold up here on the deck, and I don’t want to
          catch cold with wet furs.{" "}
        </p>
        <p>(End of Act 2)</p>
      </Row>
      ...
      <Row>
        <p>
          ...
          by sunrise… Oh, thank you human, how nice of you. Warm drinks are the
          best. Now, if you don’t mind me adding a sardine in there…
        </p>
        <p>
        ...
        <p>
          He is a mysterious one, I tell you. Even I can’t always tell what he’s
          planning on, so I totally doubted if the records could help. But the
          researcher, she was totally confident in her data. I totally need to
          give her a lesson on no stalking policy, though.
        </p>
        <p>--</p>
      </Row>
      ...
      <Row>
        <p>--</p>
        <p>
          “What do you think?” She asked. I think she was waiting for a positive
          answer, but—
        </p>
        <p>
          “Human, I really can’t tell. He is such a mysterious penguin.” I said.
        </p>
        ...
        <p>
          “I appreciate that, human. And I’m glad you listened to my lessons on
          how to talk with penguins.”
        </p>
        ...
        <p>
          The researcher sat in silence, looking sad for a while, but eventually
          she stood up.{" "}
        </p>
      ...
      <Row>
        ...
        <ul>
          <li>
            Update to dataset: a new column “Recorded Snowstorm around the Time”
            is now added. It’s a binary column showing if there has been a
            recorded snowstorm around the estimated time of the year.{" "}
          </li>
          <li>
            Using the new column, try to predict what kinds of data record most
            possibly indicate snowstorms, and decide how likely it is that the
            missing cousin was caught in a snowstorm.{" "}
          </li>
        </ul>
      </Row>
      ...
      <Row>
        ...
        <p>
          ...
          things surely looked bad. At the end, I thought we were stuck. It was
          late in the night, and both of us were exhausted. People have tried to
          search the place where my cousin last appeared, and nothing was found.
          I was making up my mind to accept that he was lost forever.{" "}
        </p>
        <p>
          And that’s when the airmails arrived at the Palmer Station. In there,
          humans found a curious postcard from, I think you called that place
          Falkland Islands. And guess what? My cousin made his bill print on the
          postcard! He has left the snow lands and gone that far, and till today
          I still have no idea how he did that. The researcher would say let’s
          pull up the ship schedules and see if he caught a ship just like I do.
          I would say thanks but I’m too tired to go through your records once
          more. But we did it anyways—we compared the size of the bill print
          with the records, and they surely matched.{" "}
        </p>
        <p>
        ...
        <p>
          Now, since my furs are dry, and so is your shaggy pocket, I suggest we
          both take a nap, and keep it warm through this windy night. The warm
          air from heaters is so nice, and I bet tomorrow we will see a
